...
b2=tk.Button(win,text="Back",font=("Arial",13),bg='black',command=back)
...
Button4 = Checkbutton(win, text = "track your steps",font='arial 15 bold')
  
                       
Button5 = Checkbutton(win, text = "8hours of sleep",font='arial 15 bold')
  
                     
Button6 = Checkbutton(win, text = "min 300 cal burn",font='arial 15 bold')
  
                      
    
Button7 = Checkbutton(win, text = "min 5000 steps",font='arial 15 bold')
